...
public class PerformanceAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.printf("Ethernet Usage: %.2f%%\n", ethernetUsage);
    ...
    private static void generateAISuggestions(double cpuLoad, double memoryUsed, double diskUsage, double ethernetUsage) {
        if (cpuLoad > 80) {
